...
chrome_step('Page.navigate',{url: 'https://www.straitstimes.com/search?searchkey=elderly'}); sleep(1000);
techo('https://www.straitstimes.com/search?searchkey=elderly' + ' - ' + chrome.getTitle() + '\n');});

casper.then(function() {techo('wait 0.2');});
casper.then(function() {casper.wait(200, function() {});});

casper.then(function() {{techo('click (//*[@id="resultdata"])[1]//a');
casper.waitFor(function check() {return check_tx('(//*[@id="resultdata"])[1]//a');},
function then() {chrome.click(tx('(//*[@id="resultdata"])[1]//a'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/news_error.png');
this.echo('ERROR - cannot find (//*[@id="resultdata"])[1]//a').exit(); this.wait(0);});}});

casper.then(function() {techo('wait 150s');});
casper.then(function() {casper.wait(150000, function() {});});
