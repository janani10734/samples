...
var email = 'quick_email';
var password = 'quick_pass';
var user_email = 'mickey_mouse@disney.com';
var user_password = 'iloveminnie4eva';
var show_info = 'Show full information';
var click_link = 'click `facebook_link`';
var facebook_link = '//*[@id="profile_full"]//a';

// flow path for save_text and snap_image
var flow_path = 'C:/Users/Janani/TagUI_Windows/tagui/flows/samples';
...
//visit the pages
casper.then(function() {{ask_result = ''; ask_result = chrome.evaluate(function() {
return prompt('What item do you want to purchase?');}); if (ask_result == null) ask_result = '';}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://shopee.sg/supermarket'}); sleep(1000);
techo('https://shopee.sg/supermarket' + ' - ' + chrome.getTitle());});

casper.then(function() {{techo('type //*[@class="_3P5w8a"] as '+search+'');
casper.waitFor(function check() {return check_tx('//*[@class="_3P5w8a"]');},
function then() {chrome.sendKeys(tx('//*[@class="_3P5w8a"]'),''+search+'');},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find //*[@class="_3P5w8a"]').exit(); this.wait(0);});}});

casper.then(function() {techo('wait 0.1');});
casper.then(function() {casper.wait(100, function() {});});
...
{sikuli_step('snap page.png to C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find [enter] on screen').exit(); this.wait(0);}}});

casper.then(function() {techo('wait 0.1');});
casper.then(function() {casper.wait(100, function() {});});

casper.then(function() {{techo('click (//*[@class="WsIMr7"])[1]//a');
casper.waitFor(function check() {return check_tx('(//*[@class="WsIMr7"])[1]//a');},
function then() {chrome.click(tx('(//*[@class="WsIMr7"])[1]//a'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="WsIMr7"])[1]//a').exit(); this.wait(0);});}});

casper.then(function() {techo('wait 0.1');});
casper.then(function() {casper.wait(100, function() {});});

casper.then(function() {{techo('read (//*[@class="Ybrg9j"]) to price1');
casper.waitFor(function check() {return check_tx('(//*[@class="Ybrg9j"])');},
function then() {price1 = chrome.fetchText(tx('(//*[@class="Ybrg9j"])')).trim();},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="Ybrg9j"])').exit(); this.wait(0);});}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://www.fairprice.com.sg/'}); sleep(1000);
techo('https://www.fairprice.com.sg/' + ' - ' + chrome.getTitle());});

casper.then(function() {{techo('type //*[@class="sc-hobbk2-1 eJNCcW"] as '+search+'');
casper.waitFor(function check() {return check_tx('//*[@class="sc-hobbk2-1 eJNCcW"]');},
function then() {chrome.sendKeys(tx('//*[@class="sc-hobbk2-1 eJNCcW"]'),''+search+'');},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find //*[@class="sc-hobbk2-1 eJNCcW"]').exit(); this.wait(0);});}});
...
casper.then(function() {{techo('click (//*[@class="sc-33fjso-6 hUhLZO"])[1]//a');
casper.waitFor(function check() {return check_tx('(//*[@class="sc-33fjso-6 hUhLZO"])[1]//a');},
function then() {chrome.click(tx('(//*[@class="sc-33fjso-6 hUhLZO"])[1]//a'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="sc-33fjso-6 hUhLZO"])[1]//a').exit(); this.wait(0);});}});

casper.then(function() {techo('wait 0.1');});
casper.then(function() {casper.wait(100, function() {});});

casper.then(function() {{techo('read (//*[@class="sc-1bsd7ul-1 sc-13n2dsm-5 kxEbZl deQJPo"]) to price2');
casper.waitFor(function check() {return check_tx('(//*[@class="sc-1bsd7ul-1 sc-13n2dsm-5 kxEbZl deQJPo"])');},
function then() {price2 = chrome.fetchText(tx('(//*[@class="sc-1bsd7ul-1 sc-13n2dsm-5 kxEbZl deQJPo"])')).trim();},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="sc-1bsd7ul-1 sc-13n2dsm-5 kxEbZl deQJPo"])').exit(); this.wait(0);});}});
...
casper.then(function() {if ((price2 < price1))
{ // start of code block
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://www.google.com'}); sleep(1000);
techo('https://www.google.com' + ' - ' + chrome.getTitle());});

casper.then(function() {{techo('keyboard [ctrl]v'); var fs = require('fs');
if (!sikuli_step('keyboard [ctrl]v')) if (!fs.exists('[ctrl]v') && !false)
{this.echo('ERROR - cannot find image file [ctrl]v').exit(); this.wait(0);} else
{sikuli_step('snap page.png to C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find [ctrl]v on screen').exit(); this.wait(0);}}});
...
casper.then(function() {{techo('click (//*[@class="g"])[1]//a');
casper.waitFor(function check() {return check_tx('(//*[@class="g"])[1]//a');},
function then() {chrome.click(tx('(//*[@class="g"])[1]//a'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="g"])[1]//a').exit(); this.wait(0);});}});

casper.then(function() {techo('wait 0.1');});
casper.then(function() {casper.wait(100, function() {});});

casper.then(function() {{techo('click  (//*[@class="sc-1axwsmm-4 gZcnCB"])');
casper.waitFor(function check() {return check_tx('(//*[@class="sc-1axwsmm-4 gZcnCB"])');},
function then() {chrome.click(tx('(//*[@class="sc-1axwsmm-4 gZcnCB"])'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="sc-1axwsmm-4 gZcnCB"])').exit(); this.wait(0);});}});

} // end of code block
});

casper.then(function() {if ((price1 < price2))
{ // start of code block
...
casper.then(function() {{techo('click  (//*[@class="btn btn-tinted btn--l _3Kiuzg _1D3GfE"])');
casper.waitFor(function check() {return check_tx('(//*[@class="btn btn-tinted btn--l _3Kiuzg _1D3GfE"])');},
function then() {chrome.click(tx('(//*[@class="btn btn-tinted btn--l _3Kiuzg _1D3GfE"])'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="btn btn-tinted btn--l _3Kiuzg _1D3GfE"])').exit(); this.wait(0);});}});

casper.then(function() {{techo('type username as grocerylover');
casper.waitFor(function check() {return check_tx('username');},
function then() {chrome.sendKeys(tx('username'),'grocerylover');},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find username').exit(); this.wait(0);});}});

casper.then(function() {{techo('type password as Janani10');
casper.waitFor(function check() {return check_tx('password');},
function then() {chrome.sendKeys(tx('password'),'Janani10');},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find password').exit(); this.wait(0);});}});

casper.then(function() {{techo('click  (//*[@class="_1ruZ5a _3Nrkgj _3kANJY _1IRuK_ hh2rFL _3_offS"])');
casper.waitFor(function check() {return check_tx('(//*[@class="_1ruZ5a _3Nrkgj _3kANJY _1IRuK_ hh2rFL _3_offS"])');},
function then() {chrome.click(tx('(//*[@class="_1ruZ5a _3Nrkgj _3kANJY _1IRuK_ hh2rFL _3_offS"])'));},
function timeout() {chrome.capture('C:/Users/Janani/TagUI_Windows/tagui/flows/samples/grocery_error.png');
this.echo('ERROR - cannot find (//*[@class="_1ruZ5a _3Nrkgj _3kANJY _1IRuK_ hh2rFL _3_offS"])').exit(); this.wait(0);});}});

} // end of code block
});

casper.then(function() {techo('wait 100');});
casper.then(function() {casper.wait(100000, function() {});});
